...
public class BTreeFile extends IndexFile
    ...
    /**
     * delete leaf entry  given its {@literal <key, rid> } pair.
     * `rid' is IN the data entry; it is not the id of the data entry)
     *
     * @param key the key in pair {@literal <key, rid>}. Input Parameter.
     * @param rid the rid in pair {@literal <key, rid>}. Input Parameter.
     ...
     * (5) lo_key!= null, hi_key!= null, {@literal lo_key < hi_key }
