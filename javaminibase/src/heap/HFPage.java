...
public class HFPage extends Page
  ...
  */
     ...
     *
     * @throws IOException I/O errors
     *                     in C++ {@literal Status insertRecord(char *recPtr, int recLen, RID& rid) }
     ...
     *
     * @throws IOException I/O errors
     *                     in C++ {@literal Status deleteRecord(const RID& rid) }
     ...
     * @throws IOException I/O errors
     *                     in C++ {@literal Status firstRecord(RID& firstRid) }
     */
     ...
     * @throws IOException I/O errors
     *                     in C++ {@literal Status nextRecord (RID curRid, RID& nextRid) }
     */
     ...
     * <br>
     * {@literal Status getRecord(RID rid, char *recPtr, int& recLen)}
     *
     ...
     * <br>
     * in C++	Status return {@literal Record(RID rid, char*& recPtr, int& recLen) }
     *
     * @param rid the record ID
